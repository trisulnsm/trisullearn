...
export const jsonLd = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is AI Query (IPDR) in Trisul?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "AI Query (IPDR) is an AI-assisted investigation and query workflow in Trisul that helps operators search and analyze IPDR datasets, subscriber records, session metadata, and attribution-related information more efficiently."
      }
    },
    {
      "@type": "Question",
      "name": "Why is AI-assisted querying useful for IPDR investigations?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "AI-assisted querying helps operators reduce the operational complexity involved in investigating large IPDR datasets containing subscriber activity, timestamps, NAT mappings, session records, and historical telemetry."
      }
    },
    {
      "@type": "Question",
      "name": "Does AI Query (IPDR) replace traditional search filters?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. AI Query complements traditional IPDR search and filtering workflows by simplifying operational querying and investigation workflows while still allowing direct analytical control where needed."
      }
    },
    {
      "@type": "Question",
      "name": "Why are IPDR investigations operationally difficult?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "IPDR investigations often require operators to correlate subscriber identifiers, IP addresses, timestamps, NAT translations, session records, and historical activity across very large datasets under operational or compliance time pressure."
      }
    }
  ]
};
