...
export const jsonLd = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is OSS BSS?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "OSS BSS refers to the operational support systems and business support systems used by telecom operators and service providers to manage provisioning, subscriber operations, billing, service assurance, and telecom service delivery workflows."
      }
    },
    {
      "@type": "Question",
      "name": "What does OSS do?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "OSS manages operational and technical workflows such as provisioning, fault management, service activation, inventory management, and service assurance across telecom infrastructure."
      }
    },
    {
      "@type": "Question",
      "name": "What does BSS do?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "BSS manages customer-facing business processes such as billing, charging, subscriber management, customer care, product catalogs, and revenue operations."
      }
    },
    {
      "@type": "Question",
      "name": "Why is OSS BSS important?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "OSS BSS platforms are important because telecom operators must synchronize network operations, subscriber activity, service delivery, and billing workflows accurately across large operational environments."
      }
    }
  ]
};
...
|---|---|
| OSS | Provisioning, assurance, network operations, and infrastructure workflows |
| BSS | Billing, charging, subscriber operations, and customer-management workflows |
| Together | End-to-end telecom service lifecycle management |
